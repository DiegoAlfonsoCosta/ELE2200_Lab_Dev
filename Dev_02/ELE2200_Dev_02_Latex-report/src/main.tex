...
%\lstinputlisting[language=Matlab,inputencoding=utf8/latin1]{Script_devoir2.m}
    ...
    \subsection{Réponses à un échelon unitaire de la consigne $x_{ref}$}

    %todo presentation tableau

    La table \ref{fig:q3a} présente les réponses en $x$obtenus pour les deux modèles en réponse à un échelon unitaire de la consigne $x_{ref}$.
    ...
    %todo commentaires warning

    \subsection{Réponses à une consigne d'atterrissage}
%    todo persentation tableau
    \begin{figure}[H]
        \centering
    ...
    FAIRE lE ACTUAL CALCU

    Pour les deux modèles, cette valeur maximale reste inférieure à $15^\circ$.
