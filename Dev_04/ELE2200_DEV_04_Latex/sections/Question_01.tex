...
p_3 = -0.3
\end{cases}$$
\noindent Les pôles du système en boucle ouverte sont tous réels et négatifs, ce qui confirme que le système est stable sans oscillations. En boucle fermée, les pôles $p_2$ et $p_3$ restent réels négatifs, mais une paire de pôles complexes conjugués $p_0$ et $p_1$ apparaît avec une partie réelle de $-0.0057$ et une partie imaginaire de $\pm 0.0545$. Puisque toutes les parties réelles sont négatives, le système en boucle fermée est également stable. Cependant, la présence de la paire complexe conjuguée indique que la réponse temporelle sera oscillatoire et amortie, ce qui se confirmera dans les simulations des questions suivantes.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{Q1h_erp.png}
